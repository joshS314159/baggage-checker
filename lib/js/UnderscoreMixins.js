(function UnderscoreMixins(logger, modules){
    ...
    const _Compare_ = (function Compare(){
        ...
        const compare = function compare(a, b){
            if(typeof(a) !== typeof(b)){
                const message = "both arguments must be of the same type";
    ...
    const _PluckFunction_ = (function PluckFunction(){
        const pluckFunction = function pluckFunction(o, key){
            console.log(arguments, _.pluck(o,key))
            // return o[key];
        }
        
        return pluckFunction;
    }());
