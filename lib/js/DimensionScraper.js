(function DimensionScraper($, logger, modules){
    'use strict';
    ...
    const _Parser_ = function Parser(_data_){
        
        MODULES.LuggageData = (function LuggageData(){
            ...
            const exporter = function exporter(){
                return {
                    data: pageDataHandler(_data_),
                };
            };
        
        
            const main = function main(){
                logger.moduleLoad("DimensionScraper -> _Parser_ -> LuggageData");
                return exporter();
            }
            return main();
        }());
